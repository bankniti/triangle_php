...
class TriangleTest extends TestCase
{
    public function testID_1()
    {
        ...
        $this->assertEquals('Input is not an integer', $triangle->runTriangle()['answer'], 'Input is not an integer');
    }
    public function testID_2()
    {
        $triangle = new triangle(-1,1,1);
        $this->assertEquals('Input is out of range', $triangle->runTriangle()['answer'], 'Input is out of range');
    }
